...
4) A database user named *ovss_root* with password *123456* is also required (you can change this afterwards according to your own preferences). This user should have full access to database *ovss_db* for everything to work. 
